...
const BUILD_ID = "0.1.914-82c23ba269ea";
const CACHE_PREFIX = "yagodka-web-cache-";
const CACHE = CACHE_PREFIX + BUILD_ID;
const PRECACHE_URLS = [
  "./assets/app-chat-host-deferred-BDNxVFvo.js",
  "./assets/app-chat-surface-media-CH8rALFw.js",
  "./assets/app-chat-surface-secondary-IUFcaIi0.js",
  "./assets/app-context-actions-d7ZTM_2e.js",
  "./assets/app-debug-BXGs5fAN.js",
  "./assets/app-emoji-LgX7hx2H.js",
  "./assets/app-files-ClWcy0IU.js",
  "./assets/app-handle-server-message-G8WoQQDu.js",
  "./assets/app-history-U1IbFa2p.js",
  "./assets/app-nav-deferred-BPUxC3Ak.js",
  "./assets/app-navigation-CZJwUgai.js",
  "./assets/app-pwa-DlqI52ic.js",
  "./assets/boot-helpers-4X6DxwZF.js",
  "./assets/index-Cyw_ELfl.css",
  "./assets/index-sGvrCJj2.js",
  "./assets/rolldown-runtime-1Lj4tb1c.js",
  "./boot.js",
  "./icons/icon-192.png",
  "./icons/icon-512.png",
